...
public class BaseImageDecoder implements ImageDecoder
{
    ...
    {
        return decode(decodingInfo, getImageStream(decodingInfo));
    }
    @Override
    public Bitmap decode(ImageDecodingInfo decodingInfo, byte[] imageData) throws IOException
    {
        return decode(decodingInfo, new ByteArrayInputStream(imageData));
    }
     ...
     * @throws UnsupportedOperationException if image URI has unsupported scheme(protocol)
     */
    private Bitmap decode(ImageDecodingInfo decodingInfo, InputStream imageStream) throws IOException
    {
